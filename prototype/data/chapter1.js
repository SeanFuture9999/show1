...
const CHAPTER1 = [
  ...
  { type: 'say', speaker: '旻赫', text: '（前世——她是唯一一個在朴在成面前替我說話的人。被報復了三個月，最後被逼到自己辭職。）' },
  ...
  // 旻赫的佈局揭曉（內心戲）
  { type: 'cg_hide' },
  { type: 'bg', src: 'office_empty_v2.jpg' },
  ...
  { type: 'bg', src: 'parking_garage_v2.jpg' },
  ...
  { type: 'say', speaker: '旻赫', text: '9:12——九分鐘後——朴部長把同一份檔案轉寄給吳常務。寄件人改成自己。附件的文件屬性沒改：創建者姜旻赫，創建時間 3/22 凌晨 2:14。' },
  { type: 'say', speaker: '朴在成', text: '（強撐）那是正常流程——下屬做的東西，上級彙整後呈報，本來就掛部門主管的名字。哪個部門不是這樣？' },
  { type: 'say', speaker: '旻赫', text: '彙整呈報——可以。但朴部長在週會上說的是：「我個人花了大量時間梳理數據。」' },
  { type: 'say', speaker: '旻赫', text: '而且，這不只是掛名的問題。這份報告的績效考核，登記在朴部長名下。考績加分 12 分。我的考績紀錄——零分。' },
  { type: 'narrate', text: '會議室裡有人倒吸一口氣。吳常務的眉頭皺了起來——他在那場週會上親口誇過朴在成「進步不少」。' },
  { type: 'say', speaker: '朴在成', text: '（笑容撐不住了）績效登記是 HR 的事——我沒有動過——' },
  ...
  { type: 'say', speaker: '旻赫', text: '專案交出去的時候——簽核人寫的是朴部長。李代理的名字，提案書上一個字都沒有。' },
  { type: 'say', speaker: '旻赫', text: '李代理去問。朴部長說：「你還在試用期，掛名不合規定。等你轉正再說。」但公司規定裡沒有這一條。我查過了。' },
  { type: 'say', speaker: '朴在成', text: '（額頭冒汗）李代理那個案子確實有很多問題——我後來花了大量時間修改——' },
  { type: 'say', speaker: '旻赫', text: '朴部長說的是哪個版本的修改？因為最終交付版本的文件屬性，修改者只有李代理一個人。' },
  { type: 'say', speaker: '旻赫', text: '還有。今年二月。張代理的客戶被朴部長私下轉給自己負責——理由是「資深人員接手比較穩妥」。結果？那個客戶續約了。續約獎金——四百二十萬韓元——全部算在朴部長名下。' },
  { type: 'narrate', text: '法務部的人在做筆記。' },
  { type: 'say', speaker: '旻赫', text: '最後——金智媛。' },
  { type: 'narrate', text: '朴在成的身體繃緊了。' },
  { type: 'say', speaker: '旻赫', text: '上週。智媛的客戶提案被退回。朴部長當眾說她能力不行、做事不如新人。' },
  { type: 'say', speaker: '旻赫', text: '但那封退回郵件的發件人——張代理——上週出差不在辦公室。而且智媛原本交出去的版本和被退回的版本，不是同一個檔案。' },
  { type: 'say', speaker: '旻赫', text: '有人改了她的提案，然後用別人的名義退回來，再當眾羞辱她。朴部長——只有您有權限動智媛的專案檔案。' },
  { type: 'narrate', text: '朴在成的嘴唇在顫。法務部的目光已經釘在他身上了。' },
  { type: 'say', speaker: '朴在成', text: '（聲音拔高）你！你一個來了一個月的新人——你怎麼知道李代理、張代理的事！你根本不在場！這是捏造！' },
  { type: 'say', speaker: '旻赫', text: '（沒有提高音量）不是我知道的。是他們告訴我的。因為朴部長對我出手之後——他們來找我了。' },
  ...
  { type: 'say', speaker: '旻赫', text: '最近三個月，經營企劃部法人信用卡的報帳紀錄。其中十四筆，合計四千七百萬韓元——收據上的餐廳名字，我一一查過。查無此店。營業登記不存在。' },
  ...
  { type: 'say', speaker: '旻赫', text: '哪位客戶？' },
  { type: 'say', speaker: '朴在成', text: '……' },
  { type: 'say', speaker: '旻赫', text: '4/19。報帳：「部門加班餐費」。金額：二十五萬。但那天整個部門沒有人加班——我調了門禁紀錄。收據上的地址——是百貨公司地下一樓。一家童裝店。' },
  ...
  { type: 'narrate', text: '他在咆哮。整層樓都聽得到。但旻赫沒有動。他等。等朴在成把所有的底牌都甩完。' },
  ...
  { type: 'say', speaker: '旻赫', text: '朴部長每週二中午跟韓星科技業務部長金昌浩在停車場碰面。我以為是正常的業務聯繫——' },
  { type: 'say', speaker: '旻赫', text: '直到我發現：韓星科技去年拿到的三個盛元外包案，報價都比市場高 30%。決標簽核人——朴在成。' },
  { type: 'narrate', text: '法務部的人翻開文件，互看了一眼。' },
  { type: 'say', speaker: '旻赫', text: '收回扣。跟外包商串通抬價。這不是灰色地帶了。' },
  { type: 'narrate', text: '朴在成的嘴唇動了。但沒有聲音出來。眼神從憤怒變成恐懼，再從恐懼變成……空洞。' },
  ...
  { type: 'say', speaker: '旻赫', text: '**수진이는 서울대 갈 겁니다. 걱정 마세요.**' },
  { type: 'say', speaker: '旻赫', text: '**（秀珍會考上首爾大學的。別擔心。）**' },
  { type: 'narrate', text: '朴在成像被雷劈了一樣。他從來沒有跟任何同事提過女兒的名字。他張了張嘴——但什麼都說不出來。' },
  { type: 'flash', color: '#ffffff', duration: 500 },
  { type: 'shake' },
  { type: 'arrogance', delta: -100, reason: '完美打臉' },
  { type: 'narrate', text: '旻赫走出了會議室。輕聲，只有自己聽得到——' },
  { type: 'say', speaker: '旻赫', text: '**（부장님이 저한테 서류 던진 그 날부터요. 從部長把文件甩到我桌上的那天起。）**' },
...
const CH1_BRANCHES = {
  ...
  // ===== BOSS：會議室處刑（開場風格分支，五回合攻防在主流程） =====
  // 選牌決定開場語氣，之後五回合自動展開

  'boss_seen': [
    { type: 'say', speaker: '旻赫', text: '（站起來，語氣平靜）吳常務，我先從一件小事說起。一封被已讀的郵件。' },
    { type: 'say', speaker: '【懷錶】', text: '[[從最小的裂縫開始。讓它自己裂開。]]' },
  ],

  'boss_cain': [
    { type: 'say', speaker: '旻赫', text: '（站起來）吳常務，在說我的事之前——我想先替幾個人說話。' },
    { type: 'say', speaker: '【懷錶】', text: '[[該隱的印記。讓他的受害者先開口。]]' },
  ],

  'boss_gluttony': [
    { type: 'say', speaker: '旻赫', text: '（站起來，直接切入）吳常務。朴部長提到十五年忠誠——我想先聊聊這十五年裡，四千七百萬去了哪裡。' },
    { type: 'say', speaker: '【懷錶】', text: '[[暴食。直搗黃龍——他的胃，今天該清空了。]]' },
  ],

  'boss_judgement': [
    { type: 'say', speaker: '旻赫', text: '（站起來。不急不慢。整理袖口。）吳常務，我準備了一些資料。不多——但每一頁都有簽名和時間戳。' },
    { type: 'say', speaker: '【懷錶】', text: '[[審判。讓證據先說話。冷靜是最鋒利的刀。]]' },
  ],

  'boss_fool': [
    { type: 'say', speaker: '旻赫', text: '（微笑，語氣像在請教）朴部長，在法務部問您之前——我有幾個小問題想確認。可以嗎？' },
    { type: 'narrate', text: '朴在成冷笑。他以為這個新人要在法務部面前丟臉。' },
    { type: 'say', speaker: '【懷錶】', text: '[[愚者。讓他自己說——謊話說得越多，摔得越重。]]' },
  ],
};
